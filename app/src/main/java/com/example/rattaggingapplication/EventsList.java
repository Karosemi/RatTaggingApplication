...
public class EventsList extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        Cursor eventsCursor = sqlDataBaseHandler.getValuesFromTable(FeedEvents.FeedEntryEvents.TABLE_NAME, columnsToReturn, FeedEvents.FeedEntryEvents.COLUMN_NAME_USER_ID,
                selectionArgs);
